  ...
  return (
    <div className="px-6 md:px-12 lg:px-20 pt-12 pb-20">
      <div className="max-w-3xl mx-auto">
        ...
        {/* 核心结论 */}
        <div className="glass-card p-6 md:p-8 mb-10 border-l-4 border-lavender-400">
          <h2 className="font-medium text-gray-800 text-lg mb-3">一句话总结</h2>
        ...
        {/* 对比表格 */}
        <h2 className="font-display text-2xl text-gray-800 mb-6">自测量表 vs 专业量表</h2>
        <div className="overflow-x-auto mb-10">
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-lavender-50">
                <th className="text-left p-4 rounded-tl-2xl font-medium text-gray-700">维度</th>
                <th className="text-left p-4 font-medium text-lavender-600">本站自测量表</th>
                <th className="text-left p-4 rounded-tr-2xl font-medium text-gray-600">医院专业量表</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={i} className="border-b border-gray-100 last:border-0">
                  <td className="p-4 font-medium text-gray-700">{dim}</td>
                  <td className="p-4 text-lavender-600">{self}</td>
                  <td className="p-4 text-gray-500">{pro}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        {/* 常见专业量表科普 */}
        <h2 className="font-display text-2xl text-gray-800 mb-6">常见的专业心理量表</h2>
          ...
          {[
            {
              ...
              tag: '焦虑',
              tagColor: 'bg-peach-50 text-peach-500',
            },
            {
              name: 'SDS（抑郁自评量表）',
              desc: '同样由 Zung 编制，20 题，用于评估抑郁情绪的严重程度，广泛应用于临床和科研。',
              tag: '抑郁',
              tagColor: 'bg-lavender-50 text-lavender-500',
            },
            {
              name: 'SCL-90（症状自评量表）',
              desc: '90 题，覆盖 9 个因子（躯体化、强迫、人际敏感等），是综合性最强的自评工具。',
              tag: '综合',
              tagColor: 'bg-mint-50 text-mint-500',
            },
            {
              name: 'PHQ-9（患者健康问卷）',
        ...
        {/* 使用建议 */}
        <h2 className="font-display text-2xl text-gray-800 mb-6">如何正确使用本站测评</h2>
        <div className="space-y-4 mb-10">
          {[
            {
              icon: '✅',
        ...
        {/* 何时需要专业帮助 */}
        <div className="p-6 bg-red-50 border-2 border-red-200 rounded-2xl mb-10">
          <div className="flex items-start gap-3">
            <span className="text-2xl flex-shrink-0">🏥</span>
            <div>
              <h3 className="font-bold text-red-700 mb-2">什么时候应该去医院？</h3>
              <ul className="space-y-2 text-sm text-red-600 leading-relaxed">
        ...
        <div className="text-center">
          <p className="text-gray-400 mb-6">了解了区别后，可以开始体验：</p>
