    ...
    <div className="px-6 md:px-12 lg:px-20 pt-12 pb-20">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="glass-card p-8 md:p-10">
          <h1 className="font-display text-3xl md:text-4xl text-gray-800 mb-2">隐私政策</h1>
          <p className="text-gray-400 text-sm mb-8">最后更新：2026 年 7 月 1 日</p>

          <div className="space-y-8 text-gray-600 text-sm leading-relaxed">
            {/* Section 1 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">一、概述</h2>
              <p>
            ...
            {/* Section 2 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">二、信息收集范围</h2>
              <div className="space-y-3">
                <div className="p-4 bg-lavender-50/50 rounded-2xl">
                  <h3 className="font-medium text-gray-700 mb-1">我们不主动收集的信息</h3>
                ...
                <div className="p-4 bg-peach-50/50 rounded-2xl">
                  <h3 className="font-medium text-gray-700 mb-1">用户主动提供的信息</h3>
                  <p className="text-gray-500">如果您选择使用以下功能，部分信息将保存在您的<strong>浏览器本地存储（localStorage）</strong>中：</p>
            ...
            {/* Section 3 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">三、数据存储方式</h2>
              <div className="p-4 bg-mint-50/50 rounded-2xl">
            ...
            {/* Section 4 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">四、数据使用目的</h2>
              <p>您主动提供的信息仅用于以下目的：</p>
              <ul className="list-disc list-inside space-y-1 text-gray-500 mt-2">
            ...
            {/* Section 5 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">五、数据安全</h2>
              <p>
            ...
            {/* Section 6 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">六、第三方服务</h2>
              <p>本站当前使用的第三方资源仅限于：</p>
              <ul className="list-disc list-inside space-y-1 text-gray-500 mt-2">
            ...
            {/* Section 7 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">七、免责声明</h2>
              <div className="p-4 bg-amber-50/80 border border-amber-200 rounded-2xl text-amber-700">
            ...
            {/* Section 8 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">八、未成年人保护</h2>
              <p>
            ...
            {/* Section 9 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">九、您的权利</h2>
            ...
            {/* Section 10 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">十、政策更新</h2>
              <p>
            ...
            {/* Section 11 */}
            <section>
              <h2 className="font-medium text-gray-800 text-lg mb-3">十一、联系我们</h2>
              <p>
                如您对本隐私政策有任何疑问或建议，欢迎通过以下方式联系我们：
              </p>
              <ul className="list-none space-y-1 text-gray-500 mt-2">
                <li>GitHub 仓库：<a href="https://github.com/caiaiji/mind-ease" target="_blank" rel="noopener noreferrer" className="text-lavender-500 hover:text-lavender-600">github.com/caiaiji/mind-ease</a></li>
