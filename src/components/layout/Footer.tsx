...
export default function Footer() {
  return (
    <footer className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border-t border-lavender-100/50 dark:border-gray-700/50 mt-20">
      ...
      <div className="bg-red-50 dark:bg-red-950/30 border-b border-red-100 dark:border-red-900/50">
        <div className="max-w-6xl mx-auto px-6 md:px-12 py-4">
          <div className="flex items-center justify-center flex-wrap gap-4 text-sm">
            <span className="font-medium text-red-700 dark:text-red-400">如果你或身边的人正处于心理危机：</span>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-medium text-gray-700 dark:text-gray-300 mb-3">探索</h3>
            <div className="flex flex-col gap-2">
              <Link to="/articles" className="text-sm text-gray-400 dark:text-gray-500 hover:text-lavender-500 transition-colors">心理文章</Link>
              <Link to="/assessment" className="text-sm text-gray-400 dark:text-gray-500 hover:text-lavender-500 transition-colors">情绪测评</Link>
              <Link to="/relax" className="text-sm text-gray-400 dark:text-gray-500 hover:text-lavender-500 transition-colors">放松工具</Link>
              <Link to="/mood-diary" className="text-sm text-gray-400 dark:text-gray-500 hover:text-lavender-500 transition-colors">情绪日记</Link>
              <Link to="/treehole" className="text-sm text-gray-400 dark:text-gray-500 hover:text-lavender-500 transition-colors">树洞倾诉</Link>
              <Link to="/games" className="text-sm text-gray-400 dark:text-gray-500 hover:text-lavender-500 transition-colors">放松游戏</Link>
              <Link to="/about" className="text-sm text-gray-400 dark:text-gray-500 hover:text-lavender-500 transition-colors">关于我们</Link>
              <Link to="/privacy" className="text-sm text-gray-400 dark:text-gray-500 hover:text-lavender-500 dark:hover:text-lavender-400 transition-colors">隐私政策</Link>
            </div>
          </div>
        ...
        <div className="mt-10 p-5 bg-amber-50/80 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/50 rounded-2xl">
